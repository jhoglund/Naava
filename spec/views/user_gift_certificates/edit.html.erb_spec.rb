...
describe "/user_gift_certificates/edit.html.erb" do
  ...
  it "renders the edit user_gift_certificate form" do
    render

    response.should have_tag("form[action=#{user_gift_certificate_path(@user_gift_certificate)}][method=post]") do
